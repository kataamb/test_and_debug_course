...
COPY adv_uuid.profiles (id, nickname, fio, email, phone_number, password)
...
COPY adv_uuid.customers (id, profile_id, rating)
FROM '/data_tables_uuid/customer.csv'
DELIMITER ';';

-- Загрузка данных в таблицу sellers
COPY adv_uuid.sellers (id, profile_id, rating)
...
FROM '/data_tables_uuid/liked.csv'
DELIMITER ';';
